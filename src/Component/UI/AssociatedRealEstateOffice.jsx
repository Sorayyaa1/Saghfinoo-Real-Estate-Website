...
import {AssociatedRealEstateOfficeList} from '../../core/contence/AssociatedRealEstateOfficeList'

function AssociatedRealEstateOffice(){
    return(
        <>
        <div className="py-6 px-8 font-Vazir">
            <p className="text-2xl font-bold text-end pb-6">دفتر املاک مرتبط</p>
               <div className=" flex gap-2 items-center justify-start relative">
                    <Swiper 
                        ...
                        className="swiper-container">
                            {
                                AssociatedRealEstateOfficeList.map((item,index)=>(
                                    <Link to="" key={index} >
...
export default AssociatedRealEstateOffice